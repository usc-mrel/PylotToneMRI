...
def draw_coils(axs, coil_name, colors, info=None, all_coils=None):
    ...
    if all_coils is None:
        all_coils = {
            'B11': [+1, 5], 'B12': [+0, 5], 'B13': [-1, 5],
            'B21': [+1, 4], 'B22': [+0, 4], 'B23': [-1, 4],
            'S1P': [+1, +2], 'S1S': [0, +2], 'S1T': [-1, +2],
            'S2P': [+1, +1], 'S2S': [0, +1], 'S2T': [-1, +1],
            'S3P': [+1,  0], 'S3S': [0,  0], 'S3T': [-1,  0],
            'S4P': [+1, -1], 'S4S': [0, -1], 'S4T': [-1, -1],
            'S5P': [+1, -2], 'S5S': [0, -2], 'S5T': [-1, -2]
            }
